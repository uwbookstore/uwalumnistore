...
$(document).ready(function () {
  ...
  $(
    '#custAddInfoStudentL,.degreeGoal,#custAddInfoOther,#custAdditionalDegreeGoal,#custAddInfoColR,#custAddInfoStudentR'
  ).hide();
  $('#studentIDText').parent().hide();

  $('#addCusotmerType').removeClass('col-sm-6 col-md-6 col-lg-6 col-xs-12');
  $('#customerTypeSelect')
    .removeClass('wauto displayib')
  ...
  $('.home-hero-img').attr(
    'src',
    $('.home-hero-img').attr('src') + '?v=2' + month + day + year
  );
  $('.home-hero-img-sm').attr(
    'src',
    $('.home-hero-img-sm').attr('src') + '?v=2' + month + day + year
  );
  $('.home-hero-img-sm2').attr(
    'src',
    $('.home-hero-img-sm2').attr('src') + '?v=2' + month + day + year
  );
  ...
  $('#women ul.featured li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#womens-main');
  $('#women ul.tops li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#womens-main');
  $('#women ul.bottoms li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#womens-main');
  $('#women ul.accessories li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#womens-main');
  //$('#womens-main li a.main-cat').hide();

  $('#men ul.featured li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#mens-main');
  $('#men ul.tops li a')
  ...
  $('#gifts-acc ul.featured li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#gift-main');
  $('#gifts-acc ul.for-the-home li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#gift-main');
  $('#gifts-acc ul.miscellaneous li a')
    .clone()
    .addClass('menu__grid--item')
    .appendTo('#gift-main');
  ...
  $('#women ul.featured li a')
    ...
    .appendTo('#womens-featured');
  $('#women ul.tops li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#womens-tops');
  $('#women ul.accessories li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#womens-accessories');

  // Mens
  $('#men ul.featured li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#mens-featured');
  $('#men ul.tops li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#mens-tops');
  $('#men ul.accessories li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#mens-accessories');

  // Kids
  $('#kids ul.featured li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#kids-featured');
  $('#kids ul.infant li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#kids-infant');
  $('#kids ul.toddler li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#kids-toddler');
  $('#kids ul.youth li a')
    .clone()
    .addClass('menu__grid--item cat-link mx-0')
    .appendTo('#kids-youth');
  ...
  $('#kids ul.toddler li.toddler.kds-acc a')
    .clone()
    .appendTo('#accessories-kids');
  ...
  /* Account Options */
  if (
    $('#h_nav a:contains("Log Out")').length ||
    $('#v_nav a:contains("Log Out")').length
  ) {
    $('#login').html(
      [
        '<li><a href="https://secure2.mbsbooks.com/CustomerProfile?s=' +
          subUrl +
          '">Update Your Profile</a></li>',
        '<li><a href="https://secure2.mbsbooks.com/AddressBook?s=' +
          subUrl +
          '">Maintain Shipping Address Book</a></li>',
        '<li><a href="https://secure2.mbsbooks.com/Orders?s=' +
          subUrl +
          '">Track Orders</a></li>',
    ...
    $('#login').html(
      [
        '<li><a href="https://secure2.mbsbooks.com//CustomerRegister?s=' +
          subUrl +
          '">Register</a></li>',
  ...
  function search() {
    ...
    if (isNaN(search_input) == true) {
      document.location.href =
        baseUrl + 'merchlist?searchtype=all&txtSearch=' + search_input;
    } else {
      document.location.href =
        baseUrl + 'merchlist?searchtype=all&txtSearch=' + search_input;
    }
  ...
  function search_dt() {
    ...
    if (isNaN(search_input_dt) == true) {
      document.location.href =
        baseUrl + 'merchlist?searchtype=all&txtSearch=' + search_input_dt;
    } else {
      document.location.href =
        baseUrl + 'merchlist?searchtype=all&txtSearch=' + search_input_dt;
    }
