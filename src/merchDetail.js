$(document).ready(function () {
  ...
  if (imgArray > 0) {
    $('<div class="flexslider"><ul class="slides merch__detail-slides"></ul></div>').appendTo("div#merch-imgs");
    for (var i = 0; i < imgArray; i++) {
      $('<li id="thumbnail_' + i + '"><img id="fullsize_' + i + '" alt="" class="merch__detail-img"></li>').appendTo(
        "ul.slides"
      );
  ...
  $('<h2 class="merch__detail-title">' + prodName + "</h2>").appendTo("div#merch-info");

  // Price blockk
  var prodPrice = $("span.merchPriceCurrent").text();
  var salePrice = $("span.merchPriceCurrent").text();
  $('<div id="priceBlock" class="merch__detail-price"></div>').appendTo("div#merch-info");
  ...
  $('<div class="merch__detail-description-open ">' + description + "</div>").appendTo("div#description-block");
  $(noAddCart).addClass("alert alert-warning text-center m5").appendTo("#description-block");
  ...
  if (sizes.length > 0) {
    ...
    $('<label class="merch__detail-size-label">Size |</label>').prependTo("div#sizes");
  } else if (logos.length === 0 && sizes.length === 0 && $("span.selectedSize").length) {
  ...
  //     $('<div id="size_' + i + '" data-name="' + $(this).text() + '"></div>').appendTo(
  //       ".grid.merch__detail-size-picker"
  //     );
  ...
  $("p.merchDisclaimerError, p.merchSelectError, p.addGiftErrorLCS, p.addGiftError").prependTo("div#sizes");
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 8) === "Champion") {
    $(
      '<a href="https://i.univbkstr.com/sizeChart/champion/" class="merch__detail-size-link gtmSizeTrack" title="Size Guide">Size Guide</a>'
    ).insertAfter(".merch__detail-size-label");
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 9) === "Game Bibs") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 8) === "Columbia") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 12) === "Under Armour") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 12) === "Peter Millar") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 7) === "Blue 84") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 12) === "College Kids") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 6) === "League") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 7) === "Vantage") {
    $(
  ...
  } else if ((merchLogoTitle.length > 0 || merchSizeTitle.length > 0) && prodName.substring(0, 11) === "Alternative") {
    $(
  ...
  $('<div class="merch__detail-qty"><label for="merchQTY">Quantity: </label></div>').appendTo(".merch__detail-add");
  ...
  $('<div id="tabs__container" class="tabs__container group"></div>').appendTo("div.tabs");
  ...
  if ($(".merchSuggested").length) {
    ...
    $(".suggestedItem ").each(function (i) {
      $(this).addClass("merch__card-item").removeClass("col-sm-2 col-xs-6").appendTo("#suggested-grid");
      $(".suggestedLink").addClass("merch__card-link").attr("id", i).removeClass("textc");
      $(".suggestedImg").addClass("merch__card-img").removeAttr("width").removeClass("margin_auto");
