$(document).ready(function () {
  ...
  $(".merchItem")
    .removeClass("padding0 bottom10 col-md-3 col-sm-6 col-xs-12 merchListClear4 merchListClearTwo")
  ...
  $('</div><div id="merch__card" class="group"><div id="pagination-btm" class="text-center"></div>').insertAfter(
    ".filterColumn"
  );
  ...
  if (categoryTitle.indexOf("Laptop") > -1 || categoryTitle.toLowerCase().substring(0, 4) === "ipad") {
    $(
